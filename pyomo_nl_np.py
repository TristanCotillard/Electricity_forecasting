...
def GetElectricSystemModel_Param_Interco_Storage_GestionSingleNode(daPrices_df, areaConsumption,availabilityFactor,TechParameters,
    ...
    model.prices_sim = Param(model.AREAS_TIMESTAMP_TECHNOLOGIES, 
                                initialize=drivers_df['price_sim'].squeeze().to_dict(), domain=Any)
    ...
    def ObjectiveFunction_rule(model):  # OBJ
        ...
        return (
                quicksum(
                    (model.prices_sim[area, t, tech] * model.energy[
                        area, t, tech])
