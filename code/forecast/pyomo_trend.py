...
def GetElectricSystemModel_Param_Interco_Storage_GestionSingleNode_trend(daPrices_df, areaConsumption,availabilityFactor,TechParameters,
    ...
    def ObjectiveFunction_rule(model):  # OBJ
        ...
        return (
                quicksum(
                    (((model.p0[area, t, tech] + model.p1[area, t, tech] * model.energy[area, t, tech] + model.prices_resid[area, t] + model.prices_seasonal[area, t]) * sd_price + mean_price) * model.energy[
                        area, t, tech])
